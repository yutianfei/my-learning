...
import com.wsy.rxdemo.MainActivity;
import com.wsy.rxdemo.R;
import com.wsy.rxdemo.backdemo.CustomAsyncTask;
import com.wsy.rxdemo.backdemo.RetainedFragment;
import com.wsy.rxdemo.backdemo.CustomIterator;
import com.wsy.rxdemo.backdemo.CustomService;
...
public class BackgroundActivity extends AppCompatActivity {
    ...
    @BindView(R.id.main_s_modes)
    Spinner mSModesSpinner; // 切换模式
    @BindView(R.id.main_s_track_leaks)
    Switch mSTrackLeaks; // 检测内存
    @BindView(R.id.main_tv_progress_text)
    TextView mTvProgressText; // 处理文本
    @BindView(R.id.main_pb_progress_bar)
    ProgressBar mPbProgressBar; // 处理条
    @BindView(R.id.main_b_start_button)
    Button mBStartButton; // 开始按钮
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSModesSpinner.post(new Runnable() {
            @Override
            public void run() {
                mSModesSpinner.setOnItemSelectedListener(
